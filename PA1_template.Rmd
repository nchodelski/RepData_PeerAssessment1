...
```{r, timeseriesplot1, fig.height = 6, fig.width=8, echo=T}
...
There were **`r number_na`** NA values in the whole data set, which means that there were `r number_na/288` days missing data.
...
I calculated the total number of steps taken each day, using the new dataset with all `r count_replaced` missing values filled in. I then found the mean and median values. 
...
``` {r, timeseriesplot2, fig.height = 7, fig.width=9, echo = TRUE}
library(stats)
